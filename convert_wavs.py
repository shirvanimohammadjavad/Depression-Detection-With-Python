...
"""
یک کد کاربردی که برای تبدیل نمونه های صوتی مناسب برای استخراج ویژگی استفاده می شود
...
def convert_audio(audio_path, target_path, remove=False):
    """این تابع مسیری از فایل های صوتی را به
...
def convert_audios(path, target_path, remove=False):
    """مسیری از فایل های صوتی را به:
         - نرخ نمونه برداری 16000 هرتز
         - یک کانال صوتی (مونو)
         تبدیل می کند و سپس آنها را در یک پوشه جدید قرار می دهد"""
